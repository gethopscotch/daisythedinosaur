...
var webkit_draggable = function(r, ip)
{
  this.initialize = function(root, instance_props)
  {
    ...
    var default_props = {clone: false, scroll : false, revert : false, handle : this.root, zIndex : 1000, onStart : webkit_tools.empty, onEnd : webkit_tools.empty};
  ...
  this.touchStart = function(event)
  {
    ...
    if (p.clone) {
      $(this.root).parent().append($(this.root).clone().removeAttr('id'));
    }
